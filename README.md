...
|---|---|---|---|---|
| [Main](profiles/main/) *(launcher)* | Stream Deck XL | 13 | [live](https://claude.ai/code/artifact/7af261fc-6cdb-472a-bc91-6e06f6e4eb08) · [local](profiles/main/index.html) | <img src="profiles/main/sheet.png" width="360" alt="Main launcher"> |
...
| [Microsoft PowerPoint](profiles/powerpoint/) | Stream Deck XL | 32 | [live](https://claude.ai/code/artifact/2e92727d-ae25-4022-97e0-eb15ef3b9a7e) · [local](profiles/powerpoint/index.html) | <img src="profiles/powerpoint/sheet.png" width="360" alt="PowerPoint deck"> |
| [Finder](profiles/finder/) | Stream Deck XL | 32 | [live](https://claude.ai/code/artifact/aefca619-cedb-4927-bfcd-b2f23bc707ce) · [local](profiles/finder/index.html) | <img src="profiles/finder/sheet.png" width="360" alt="Finder deck"> |
