...
The keys follow Claude's own look: warm charcoal tiles with a fine paper grain, ivory line glyphs, and labels in New York serif. Each row takes an accent from Claude's palette. The hero key is the terracotta spark from the app icon.
