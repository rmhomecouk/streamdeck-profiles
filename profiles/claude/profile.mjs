// Builds Claude.streamDeckProfile (Stream Deck 7.x, ProfilesV3 layout) for the Stream Deck XL.
...
const KEY = {
  A: [0, 65], D: [2, 68], E: [14, 69], F: [3, 70], G: [5, 71], I: [34, 73], K: [40, 75], N: [45, 78], O: [31, 79],
  P: [35, 80], T: [17, 84], U: [32, 85], W: [13, 87],
  '[': [33, 91], ']': [30, 93], '.': [47, 46], ';': [41, 59], '\\': [42, 92], '/': [44, 47], ',': [43, 44], '-': [27, 45], '=': [24, 61],
  esc: [53, 0x01000000], up: [126, 0x01000013], down: [125, 0x01000015],
};
// id -> [key, ...modifiers]; 'claude' is an Open Application action instead
const SEND = {
  'new-chat': ['N', 'cmd'], search: ['K', 'cmd'], 'quick-chat': ['K', 'cmd', 'ctrl'], incognito: ['I', 'cmd', 'shift'],
  'prev-chat': ['[', 'cmd', 'shift'], 'next-chat': [']', 'cmd', 'shift'], sidebar: ['.', 'cmd'],
  attach: ['U', 'cmd'], dictate: ['D', 'cmd'], thinking: ['E', 'cmd', 'shift'], model: ['.', 'cmd', 'shift'],
  stop: ['esc'], 'side-chat': [';', 'cmd'], close: ['W', 'cmd'], reopen: ['T', 'cmd', 'shift'],
  'open-folder': ['O', 'cmd', 'shift'], 'pane-prev': ['[', 'ctrl'], 'pane-next': [']', 'ctrl'], 'close-pane': ['\\', 'cmd'],
  'prompt-up': ['up', 'cmd', 'opt'], 'prompt-down': ['down', 'cmd', 'opt'], files: ['F', 'cmd', 'shift'], 'open-pr': ['G', 'cmd', 'opt'],
  fork: ['O', 'cmd', 'opt'], pin: ['P', 'cmd', 'opt'], archive: ['A', 'cmd', 'opt'], find: ['F', 'cmd'],
  'zoom-out': ['-', 'cmd'], 'zoom-in': ['=', 'cmd'], shortcuts: ['/', 'cmd'], settings: [',', 'cmd'],
};
