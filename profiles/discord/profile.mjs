...
const APP = {
  app_name: 'Discord', args: '', bring_to_front: true, bundle_id: 'com.hnc.Discord',
  bundle_path: '/Applications/Discord.app', exec: '', is_bundle: true, long_press: 'quit', source: '',
};
...
// id -> [key, ...modifiers], from Discord's web client keybind table (build 609489; mod = cmd, alt = opt on a Mac); 'discord' is Open Application
const SEND = {
