// Builds Mail.streamDeckProfile (Stream Deck 7.x, ProfilesV3 layout) for the Stream Deck XL.
...
const OUTFILE = path.resolve(process.argv[3] || path.join(HERE, 'Mail.streamDeckProfile'));
...
const KEY = {
  A: [0, 65], D: [2, 68], E: [14, 69], F: [3, 70], H: [4, 72], J: [38, 74], K: [40, 75], L: [37, 76],
  M: [46, 77], N: [45, 78], R: [15, 82], S: [1, 83], T: [17, 84], U: [32, 85], Y: [16, 89],
  '0': [29, 48], '1': [18, 49], '5': [23, 53], '[': [33, 91], ']': [30, 93], ',': [43, 44],
  backspace: [51, 0x01000003],
};
// id -> [key, ...modifiers], from Mail 16's MainMenu.nib, each checked in the live menu bar; 'mail' is the Switch Profile to Main
const SEND = {
  'get-mail': ['N', 'cmd', 'shift'], search: ['F', 'cmd', 'opt'], 'jump-to-top': ['T', 'cmd', 'ctrl'],
  primary: ['1', 'cmd', 'opt'], 'all-mail': ['5', 'cmd', 'opt'],
  'prev-unread': ['[', 'cmd', 'opt', 'ctrl'], 'next-unread': [']', 'cmd', 'opt', 'ctrl'],
  'new-message': ['N', 'cmd'], reply: ['R', 'cmd'], 'reply-all': ['R', 'cmd', 'shift'], forward: ['F', 'cmd', 'shift'],
  redirect: ['E', 'cmd', 'shift'], send: ['D', 'cmd', 'shift'], attach: ['A', 'cmd', 'shift'], 'add-link': ['K', 'cmd'],
  archive: ['A', 'cmd', 'ctrl'], delete: ['backspace', 'cmd'], junk: ['J', 'cmd', 'shift'], 'mark-read': ['U', 'cmd', 'shift'],
  flag: ['L', 'cmd', 'shift'], mute: ['M', 'ctrl', 'shift'], 'move-suggested': ['M', 'cmd', 'ctrl'], 'apply-rules': ['L', 'cmd', 'opt'],
  sidebar: ['S', 'cmd', 'ctrl'], favorites: ['H', 'cmd', 'opt', 'shift'], filter: ['L', 'cmd'], find: ['F', 'cmd'],
  'all-headers': ['H', 'cmd', 'shift'], 'quick-look': ['Y', 'cmd'], activity: ['0', 'cmd', 'opt'], settings: [',', 'cmd'],
};
