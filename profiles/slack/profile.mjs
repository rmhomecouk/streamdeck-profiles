...
const APP = {
  app_name: 'Slack', args: '', bring_to_front: true, bundle_id: 'com.tinyspeck.slackmacgap',
  bundle_path: '/Applications/Slack.app', exec: '', is_bundle: true, long_press: 'quit', source: '',
};
...
// id -> [key, ...modifiers], from Slack 4.52's menu template, global shortcut table and shortcuts sheet; 'slack' is Open Application
const SEND = {
